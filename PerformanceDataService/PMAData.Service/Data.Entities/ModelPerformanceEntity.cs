...
{
	/// <summary>An model performance entity. This class cannot be inherited.</summary>
	internal sealed class ModelPerformanceEntity
	{
		/// <summary>Initializes a new instance of the <see cref="ModelPerformanceEntity"/> class.</summary>
		public ModelPerformanceEntity()
		{
