...
{
	/// <summary>An benchmark performance entity. This class cannot be inherited.</summary>
	internal sealed class BenchmarkPerformanceEntity
	{
		/// <summary>Initializes a new instance of the <see cref="BenchmarkPerformanceEntity"/> class.</summary>
		public BenchmarkPerformanceEntity()
		{
